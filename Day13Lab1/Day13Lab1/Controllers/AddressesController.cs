...
namespace Day13Lab1.Controllers
{
    public class AddressesController : Controller
    {
        ...
        public async Task<IActionResult> Create(int? AnagraphicID,[Bind("AddressID,City,Region,PostalCode,Country,Phone,AddressText,MyAnagraphicAnagraphicID")] Address address)
        {
            /*/ To Do Manual Revalidation
             * var anagraphic = _context.Anagraphics
                    //.Find(AnagraphicID)
                    .SingleOrDefault(a => a.AnagraphicID == AnagraphicID);
            address.MyAnagraphic = anagraphic;
            address.MyAnagraphicAnagraphicID = anagraphic.AnagraphicID;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AddressID,City,Region,PostalCode,Country,Phone,AddressText")] Address address)
        {
